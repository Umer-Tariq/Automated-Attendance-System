...
message_frame = tk.Frame(root, bg="gray", pady=240)
message_frame.pack(side=tk.BOTTOM, fill=tk.X)

message_label = tk.Label(message_frame, text="Waiting for face detection...", font=("Helvetica", 14), bg="gray", fg="white", pady=10,anchor="center",wraplength=500)
